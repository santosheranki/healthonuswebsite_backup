...
@Component({
  selector: 'app-care-at-home-nursing',
  templateUrl: './care-at-home-nursing.component.html',
  styleUrl: './care-at-home-nursing.component.scss'
})
export class CareAtHomeNursingComponent implements OnInit {
  display: boolean = false;
  selectedTab: string = 'medical';
  splittedEvnt: any;
  ...
  ngOnInit() {
    const currentPage = "HomeNursingCare";
    ...
    menuItems.forEach((individualItems: any) => {
      ...
      if (this.splittedEvnt == 'care-at-home-nursing' && itemContent === 'Home Care Nursing') {
